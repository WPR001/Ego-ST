...
input_json_files = [
    './Part1_reverse_qa.json',
    './Part2_reverse_qa.json',
    './Part3_reverse_qa.json',
    './Part4_reverse_qa.json',
...
for idx, (json_file, video_folder) in enumerate(zip(input_json_files, video_folders)):
    ...
    for key, sample in data.items():
        ...
        question = video_prefix + sample["question"]
        ...
        print(f'Sample {key} processed. Prediction: {response}')
        combined_results[f'{idx+1}_{key}'] = sample

output_path = './reverse_qa_output.json'
