...
# SYSTEM_PROMPT = (
#     "You are a video quality assessment assistant."
# ) # quality
...
def main(script_args, training_args, model_args):
    ...
    QUESTION_TEMPLATE = "{Question} Please answer in English. Output the thinking process in <think> </think> and final answer in <answer> </answer> tags, i.e., <think> reasoning process here </think><answer> answer here </answer>. "
    # QUESTION_TEMPLATE = "{Question}" # quality
